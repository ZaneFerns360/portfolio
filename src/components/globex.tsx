...
export function GlobeDemo() {
  ...
  return (
    <div className="relative h-[50rem] px-0 md:h-[35rem] md:w-full md:px-0">
      <motion.div
        initial={{
          opacity: 0,
          y: 20,
      ...
      <div className="pointer-events-none z-40  w-full select-none " />
      <div className="-bottom-30  z-10  h-1/2 w-full md:h-full">
