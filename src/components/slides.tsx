...
export const InfiniteMovingCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20 max-w-full overflow-hidden pb-2",
        className,
      )}
    >
      <ul
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[100px] max-w-full flex-shrink-0 rounded-2xl border border-slate-700 px-8 py-6 md:w-[300px]"
            style={{
              background:
